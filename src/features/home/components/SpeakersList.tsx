...
export const SpeakersList: React.FC = () => {
  ...
  if (speakers.length === 0) {
    return (
      <div className="w-full text-center py-12 bg-dark/40 backdrop-blur-md rounded-2xl border border-accent/10 p-8 flex flex-col items-center justify-center gap-4">
        ...
        <h3 className="font-display font-bold text-base text-white">No hay ponentes registrados</h3>
